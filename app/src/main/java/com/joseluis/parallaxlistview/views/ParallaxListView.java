...
public class ParallaxListView extends ListView implements AbsListView.OnScrollListener {
    ...
    /**
     * Posicion (visible) actual de la lista
     */
    private int mPosition = 0;

    /**
     * Contador de px en la lista
     */
     ...
     */
    private static final float ALPHA_DIFF = 0.04f;
    ...
    public void onScroll(AbsListView absListView, int i, int i1, int i2) {
        ...
        //obtenemos el valor (top) en px de la primera vista
    ...
    private void parallaxEffect(float alpha) {
        ...
        if(isParallaxEnable()) {
            ...
            if (lastTopValueAssigned != rect.top) {
                ...
                mParallaxImage.setY((float) (rect.top / parallaxMode));
            }
        }
